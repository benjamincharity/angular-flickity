        ...
        it(`should be set to the passed in ID`, function(done) {
            const template = `
                <div id="wrapper">
                    ...
                    <button id="prev" bc-flickity-previous bc-flickity-id="buttonId">
                        Previous
                    </button>
                </div>
            `;
            ...
            this.PreviousController = directiveElement.controller('bcFlickityPrevious');

            // We must wrap in a $timeout since create() is also in a $timeout
            this.$timeout(() => {
                const actual = this.PreviousController.flickityId;
        ...
        it(`should be set to the ID of the first instance`, function(done) {
            const template = `
                <div id="wrapper">
                    ...
                    <button id="prev" bc-flickity-previous>
                        Previous
                    </button>
                </div>
            `;
